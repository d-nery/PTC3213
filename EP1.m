...
%%
% Limpa o espa�o de trabalho e fecha as figuras abertas
clear;
close all;

%% Constantes
% Propriedades
epsilon0 = 8.85418782e-12; % permissividade el�trica no v�cuo
epsilon = 1.9 * epsilon0;  % permissividade el�trica no meio
...
%% Convers�o do ret�ngulo para grade de pontos
% Dist�ncias convertidas para matriz de pontos
...
%% Calculo da resist�ncia e capacit�ncia
CE = 0;
for i = 2 : l-1
    CE = CE + V(i,2) + V(i,c-1);
end
