...
delta = 0.1;
prec = 0.001;
m = b/delta;          %nï¿½mero de linhas
n = a/delta;          %nï¿½mero de colunas
...
%sigma = 0.0032;        %valor da condutï¿½ncia
...
% V2 = zeros(m,n);
% 
% %problema dual - para o traï¿½ado dos quadrados curvilï¿½neos
% erro=1;
% while (erro>prec)
%     erro=0;
%     for i=1:m
...
% end
% 
% %traï¿½a os quadrados curvilï¿½neos
% m1 = 10;
